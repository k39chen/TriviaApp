...
$(document).ready(function() {
    ...
    function showQuestion(categoryId, questionId) {
        ...
        if (_.isEqual(category.category, "Ghoulish Gals")) {
          $title.html("<b>Gals</b>" + "<em>" + questionId + "</em>");
        } else if (_.isEqual(category.category, "Hellish Haunters")) {
            $title.html("<b>Haunters</b>" + "<em>" + questionId + "</em>");
        } else if (_.isEqual(category.category, "Ominous Creatures")) {
          $title.html("<b>Creatures</b>" + "<em>" + questionId + "</em>");
        } else if (_.isEqual(category.category, "Scary Screenshots")) {
            $title.html("<b>Screens</b>" + "<em>" + questionId + "</em>");
        } else if (_.isEqual(category.category, "Terror Tunes")) {
          $title.html("<b>Tunes</b>" + "<em>" + questionId + "</em>");
        } else {
